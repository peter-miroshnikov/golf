...
function cpt_slider_plugin_activation() {
	...
	set_transient('upgrade-notice', true, 5);
}

// SLIDE ANYTHING 2.0 UPGRADE NOTICE
function version_20_upgrade_notice() {
	/* Check transient, if available display notice */
	if (get_transient('upgrade-notice')) {
		echo "<div class='updated notice is-dismissible'>";
		echo "<p><strong style='color:crimson;'>SLIDE ANYTHING - UPGRADING TO VERSION 2.0</strong><br/>";
		echo "If you are upgrading to version 2.0 from a previous version, and are experiencing issues with your existing sliders, ";
		echo "please <strong>RE-SAVE</strong> all your existing sliders to resolve these issues. You do this simply by editing each ";
		echo "existing Slide Anything slider and then clicking the UPDATE button.<br/><br/>Also, if you site is running a CDN CACHE, ";
		echo "please ensure you reset/clear this cache.</p>";
		echo "</div>";
		/* Delete transient, only display this notice once. */
		delete_transient('upgrade-notice');
	}
}
